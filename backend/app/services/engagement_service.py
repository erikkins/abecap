...
class EngagementService:
    ...
    def _generate_comment(self, tweet_text: str, author: str, matched_topics: List[str],
        ...
        base_system = (
            ...
            "that hands them the answer. Pitch-y replies get ignored; specific, opinionated "
            "replies get clicks.\n\n"
            ...
            "  (b) a counterintuitive observation that pushes back against the original tweet "
            "OR against conventional fintwit wisdom. Disagreement is more engaging than agreement.\n"
