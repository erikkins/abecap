...
class EngagementService:
    ...
    def _generate_comment(self, tweet_text: str, author: str, matched_topics: List[str],
        ...
        base_system = (
            ...
            "  - Sharpe over those 21 walk-forward years: Preserver 0.87, Maximizer 0.93; the S&P scored 0.54 on the same window, "
            ...
            "  - Worst drawdown 13.7% (Preserver) / 20.8% (Maximizer) across those 21 years; raw momentum's was 57%, the index lost half twice\n"
            "  - 2008: both settings ended the year roughly flat (about +0.1%) while the index fell about 37% — in cash by design\n"
            "  - Honest wart: it trails badly in raging bulls — in 2019 Preserver made about +6% while the index ran +29%\n"
